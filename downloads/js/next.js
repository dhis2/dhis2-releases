  ...
  fetch("upcomingPatches.json")
    ...
    .then((patchReleases) => {
      ...
      for (let i = 1; i <= 3; i++) {
        ...
        tickLabel.textContent = tickDate.toLocaleString(locale, {
          month: "short",
        });
      ...
      patchReleases.forEach((release) => {
        ...
        const offsetPercentage =
          ((releaseDate - startDate) / totalDuration) * 100;
